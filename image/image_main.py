...
# Define the ResNet34 model class (same as your code)
class ResNet34(nn.Module):
    def __init__(self, in_channels, num_classes):
        ...
        # (Remaining layers are the same as your definition)

    def forward(self, xb):
        # (Forward method remains the same as your definition)
        pass

# Bird class names mapping (remains the same)
...
model = ResNet34(in_channels=3, num_classes=len(bird_name_map))
model.load_state_dict(torch.load("weights/bird-resnet34best.pth"))
...
def predict_bird(image_path, model):
    ...
    Args:
        ...
        model (nn.Module): The trained ResNet34 model.
    Returns:
        str: Predicted bird name.
    """
    ...
    return bird_name_map[predicted_class.item()]

# Example usage
image_path = "path_to_image.jpg"
predicted_bird = predict_bird(image_path, model)
